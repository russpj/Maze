 ...
 * @author Russ
 */
public class MazeSizeDlg extends javax.swing.JDialog {

    /**
     * Creates new form MazeSizeDlg
     * @param parent
     * @param modal
     */
    public MazeSizeDlg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextFieldRows.setText("jTextField1");

        jTextFieldColumns.setText("jTextField1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MazeSizeDlg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MazeSizeDlg dialog = new MazeSizeDlg(new javax.swing.JFrame(), true);
